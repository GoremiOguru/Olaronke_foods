...
import { X, CheckCircle, MessageCircle, Copy, ExternalLink, ShieldCheck, Key, MapPin } from 'lucide-react';
        ...
        <div className="p-6 space-y-5 max-h-[75vh] overflow-y-auto">
          ...
          <div className="space-y-2">
            <p className="text-xs font-bold text-slate-300 flex items-center gap-1.5">
              ...
              Forward Receipt to Isaac on WhatsApp ({whatsappPhone})
            </p>
            <p className="text-xs text-slate-400 leading-relaxed">
              Click the green button to message Isaac with your pre-formatted order details & secret code <strong>#{pickupCodeDisplay}</strong>.
            </p>
          </div>
          ...
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="w-full py-4 rounded-2xl bg-gradient-to-r from-brand-lemon to-emerald-600 hover:from-lime-400 hover:to-emerald-500 text-slate-950 font-black text-sm shadow-lemon-glow hover:scale-[1.02] active:scale-[0.98] transition-all flex items-center justify-center space-x-2 border border-brand-lemon/30"
          >
